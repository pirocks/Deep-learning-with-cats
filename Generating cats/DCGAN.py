...
parser.add_argument('--lr_D', type=float, default=.00005,
...
parser.add_argument('--input_folder', default='/mnt/harddrive2/Datasets/Misc_Plants', help='input folder')
parser.add_argument('--output_folder', default='/mnt/harddrive2/Output/DCGAN_Misc_Plants', help='output folder')
...
for epoch in range(param.n_epoch):
    ...
    for i, data_batch in enumerate(dataset, 0):
        ...
        if i % 50 == 0:
            ...
            s = fmt % (
                epoch, param.n_epoch, i, len(dataset), errD.data[0], errG.data[0], D_real, D_fake, D_G, end - start)
            print(s)
